...
Partial Public Class AnalystsDataContext
  ...
  #End Region
	...
	Public Sub New()
		MyBase.New(Global.AscensionAnalytics.My.MySettings.Default.ClaimsnetConnectionString, mappingSource)
		OnCreated
	End Sub
...
<Global.System.Data.Linq.Mapping.TableAttribute(Name:="dbo.Analysts")>  _
Partial Public Class Analyst
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_AnalystId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_AnalystRoleId", DbType:="Int NOT NULL")>  _
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="AnalystAnalysisPeople_Analyst", Storage:="_AnalystAnalysisPeople", ThisKey:="AnalysisPersonId", OtherKey:="PersonId", IsForeignKey:=true)>  _
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="AnalystRole_Analyst", Storage:="_AnalystRole", ThisKey:="AnalystRoleId", OtherKey:="AnalystRoleId", IsForeignKey:=true)>  _
...
Partial Public Class AnalystAnalysisPeople
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="AnalystAnalysisPeople_Analyst", Storage:="_Analysts", ThisKey:="PersonId", OtherKey:="AnalysisPersonId")>  _
...
<Global.System.Data.Linq.Mapping.TableAttribute(Name:="dbo.AnalystRoles")>  _
Partial Public Class AnalystRole
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_AnalystRoleId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	Public Property AnalystRoleId() As Integer
		Get
			Return Me._AnalystRoleId
		End Get
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_AnalystRole", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_DatabaseUsername", DbType:="VarChar(50)")>  _
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_DatabasePassword", DbType:="VarChar(50)")>  _
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="AnalystRole_Analyst", Storage:="_Analysts", ThisKey:="AnalystRoleId", OtherKey:="AnalystRoleId")>  _
	Public Property Analysts() As EntitySet(Of Analyst)
		Get
			Return Me._Analysts
		End Get

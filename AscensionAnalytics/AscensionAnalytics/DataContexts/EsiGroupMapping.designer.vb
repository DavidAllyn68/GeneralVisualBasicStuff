...
<Global.System.Data.Linq.Mapping.TableAttribute(Name:="dbo.ESI_Group_Map")>  _
Partial Public Class ESI_Group_Map
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_ESI_REN_GroupMapID", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_ESI_Extrn_Grp_ID", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_REN_Schoolgroup_cd", DbType:="VarChar(10) NOT NULL", CanBeNull:=false)>  _

...
Partial Public Class AmeribenMapping_AscensionBenefits
	...
	<Association(Name:="AmeribenMapping_AscensionBenefits_Ameriben_BenefitMapping", Storage:="_Ameriben_BenefitMappings", ThisKey:="BenefitId", OtherKey:="AscensionBenefitId")>  _
...
<Table(Name:="dbo.Ameriben_BenefitMapping")>  _
Partial Public Class Ameriben_BenefitMapping
	...
	<Column(Storage:="_AmeribenBenefitMappingId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_AmeribenPOS", DbType:="VarChar(10) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_AmeribenTOS", DbType:="VarChar(10) NOT NULL", CanBeNull:=false)>  _
	...
	<Association(Name:="AmeribenMapping_AscensionBenefits_Ameriben_BenefitMapping", Storage:="_Benefits", ThisKey:="AscensionBenefitId", OtherKey:="BenefitId", IsForeignKey:=true)>  _
	...
	<Association(Name:="Ameriben_POS_Ameriben_BenefitMapping", Storage:="_Ameriben_POS", ThisKey:="AmeribenPOS", OtherKey:="POSCode", IsForeignKey:=true)>  _
	...
	<Association(Name:="Ameriben_TOS_Ameriben_BenefitMapping", Storage:="_Ameriben_TOS", ThisKey:="AmeribenTOS", OtherKey:="ChargeType", IsForeignKey:=true)>  _
...
Partial Public Class Ameriben_POS
	...
	<Column(Storage:="_POSCode", DbType:="Char(2) NOT NULL", CanBeNull:=false, IsPrimaryKey:=true)>  _
	...
	<Column(Storage:="_POSDescription", DbType:="VarChar(50)")>  _
	...
	<Column(Storage:="_RenaissancePOSDescription", DbType:="VarChar(50)")>  _
	...
	<Association(Name:="Ameriben_POS_Ameriben_BenefitMapping", Storage:="_Ameriben_BenefitMappings", ThisKey:="POSCode", OtherKey:="AmeribenPOS")>  _
	Public Property Ameriben_BenefitMappings() As EntitySet(Of Ameriben_BenefitMapping)
		Get
			Return Me._Ameriben_BenefitMappings
		End Get
...
Partial Public Class Ameriben_TOS
	...
	<Column(Storage:="_ChargeType", DbType:="VarChar(5) NOT NULL", CanBeNull:=false, IsPrimaryKey:=true)>  _
	...
	<Column(Storage:="_DetailChargeType", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_SummaryChargeType", DbType:="VarChar(255) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_BenefitType", DbType:="VarChar(255) NOT NULL", CanBeNull:=false)>  _
	...
	<Association(Name:="Ameriben_TOS_Ameriben_BenefitMapping", Storage:="_Ameriben_BenefitMappings", ThisKey:="ChargeType", OtherKey:="AmeribenTOS")>  _
	Public Property Ameriben_BenefitMappings() As EntitySet(Of Ameriben_BenefitMapping)
		Get
			Return Me._Ameriben_BenefitMappings
		End Get

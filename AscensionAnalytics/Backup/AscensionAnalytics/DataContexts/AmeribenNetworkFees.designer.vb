...
<Table(Name:="dbo.Ameriben_NetworkFees")>  _
Partial Public Class Ameriben_NetworkFee
	...
	<Column(Storage:="_NetworkFeeId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_PaidDate", DbType:="SmallDateTime NOT NULL")>  _
	...
	<Column(Storage:="_schoolgroup_cd", DbType:="VarChar(10) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_Network", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _

...
<Table(Name:="dbo.AnalysisRequestLog")>  _
Partial Public Class AnalysisRequestLog
	...
	<Column(Storage:="_LogId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_AnalysisId", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_EntryText", DbType:="VarChar(8000) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_EntryTime", DbType:="SmallDateTime NOT NULL")>  _
	...
	<Column(Storage:="_EffortMinutes", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_DataActivityEntry", DbType:="TinyInt NOT NULL")>  _
	...
	<Column(Storage:="_EntryUser", DbType:="VarChar(200) NOT NULL", CanBeNull:=false)>  _
	...
	<Association(Name:="AnalysisRequest_AnalysisRequestLog", Storage:="_AnalysisRequest", ThisKey:="AnalysisId", OtherKey:="AnalysisId", IsForeignKey:=true)>  _
...
<Table(Name:="dbo.AnalysisRequestStatus")>  _
Partial Public Class AnalysisRequestStatus
	...
	<Column(Storage:="_StatusId", DbType:="Int NOT NULL", IsPrimaryKey:=true)>  _
	...
	<Column(Storage:="_Status", DbType:="VarChar(20) NOT NULL", CanBeNull:=false)>  _
	...
	<Association(Name:="AnalysisRequestStatus_AnalysisRequest", Storage:="_AnalysisRequests", ThisKey:="StatusId", OtherKey:="StatusId")>  _
...
<Table(Name:="dbo.AnalysisRequestType")>  _
Partial Public Class AnalysisRequestType
	...
	<Column(Storage:="_RequestTypeId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_RequestType", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _
	...
	<Association(Name:="AnalysisRequestType_AnalysisRequest", Storage:="_AnalysisRequests", ThisKey:="RequestTypeId", OtherKey:="RequestTypeId")>  _
	Public Property AnalysisRequests() As EntitySet(Of AnalysisRequest)
		Get
			Return Me._AnalysisRequests
		End Get
...
<Table(Name:="dbo.AnalysisRequest")>  _
Partial Public Class AnalysisRequest
	...
	<Column(Storage:="_AnalysisId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	Public Property AnalysisId() As Integer
		Get
			Return Me._AnalysisId
		End Get
	...
	<Column(Storage:="_Description", DbType:="VarChar(2000) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_Milestone", DbType:="VarChar(2000) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_MilestoneDate", DbType:="SmallDateTime NOT NULL")>  _
	...
	<Column(Storage:="_RequestorId", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_AssigneeId", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_DirectoryFullPath", DbType:="VarChar(500) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_StatusId", DbType:="Int NOT NULL")>  _
	Public Property StatusId() As Integer
		Get
			Return Me._StatusId
		End Get
	...
	<Column(Storage:="_RequestTypeId", DbType:="Int NOT NULL")>  _
	Public Property RequestTypeId() As Integer
		Get
			Return Me._RequestTypeId
		End Get
	...
	<Column(Storage:="_OpenDate", DbType:="SmallDateTime NOT NULL")>  _
	...
	<Column(Storage:="_StartDate", DbType:="SmallDateTime NOT NULL")>  _
	...
	<Column(Storage:="_EndDate", DbType:="SmallDateTime NOT NULL")>  _
	...
	<Column(Storage:="_CloseDate", DbType:="SmallDateTime NOT NULL")>  _
	...
	<Column(Storage:="_ModifiedByUser", DbType:="NVarChar(50) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_ModifiedTime", DbType:="SmallDateTime NOT NULL")>  _
	...
	<Column(Storage:="_ModifyingByUser", DbType:="NVarChar(50)")>  _
	...
	<Association(Name:="AnalysisRequest_AnalysisRequestLog", Storage:="_AnalysisRequestLogs", ThisKey:="AnalysisId", OtherKey:="AnalysisId")>  _
	...
	<Association(Name:="AnalysisRequestStatus_AnalysisRequest", Storage:="_AnalysisRequestStatus", ThisKey:="StatusId", OtherKey:="StatusId", IsForeignKey:=true)>  _
	...
	<Association(Name:="AnalysisRequestType_AnalysisRequest", Storage:="_AnalysisRequestType", ThisKey:="RequestTypeId", OtherKey:="RequestTypeId", IsForeignKey:=true)>  _
	...
	<Association(Name:="AnalysisRequestPeople_AnalysisRequest", Storage:="_AnalysisPeople", ThisKey:="AssigneeId", OtherKey:="PersonId", IsForeignKey:=true)>  _
	...
	<Association(Name:="AnalysisRequestPeople_AnalysisRequest1", Storage:="_AnalysisRequestPeople", ThisKey:="RequestorId", OtherKey:="PersonId", IsForeignKey:=true)>  _
...
<Table(Name:="dbo.AnalysisPeople_PersonType")>  _
Partial Public Class AnalysisPeople_PersonType
	...
	<Column(Storage:="_PersonTypeId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_PersonType", DbType:="VarChar(100) NOT NULL", CanBeNull:=false)>  _
	...
	<Association(Name:="AnalysisPeople_PersonType_AnalysisRequestPeople", Storage:="_AnalysisRequestPeoples", ThisKey:="PersonTypeId", OtherKey:="PersonTypeId")>  _
...
Partial Public Class AnalysisRequestPeople
	...
	<Association(Name:="AnalysisRequestPeople_AnalysisRequest", Storage:="_AnalysisRequests", ThisKey:="PersonId", OtherKey:="AssigneeId")>  _
	Public Property AnalysisRequests() As EntitySet(Of AnalysisRequest)
		Get
			Return Me._AnalysisRequests
		End Get
	...
	<Association(Name:="AnalysisRequestPeople_AnalysisRequest1", Storage:="_AnalysisRequests1", ThisKey:="PersonId", OtherKey:="RequestorId")>  _
	...
	<Association(Name:="AnalysisPeople_PersonType_AnalysisRequestPeople", Storage:="_AnalysisPeople_PersonType", ThisKey:="PersonTypeId", OtherKey:="PersonTypeId", IsForeignKey:=true)>  _

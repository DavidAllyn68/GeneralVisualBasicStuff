...
<Table(Name:="dbo.ClaremontPlanHistoryData_TagMapping")>  _
Partial Public Class ClaremontPlanHistoryData_TagMapping
	...
	<Column(Storage:="_ClaremontPlanHistoryDataTagMapId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_TagType", DbType:="VarChar(25) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_SchoolgroupCode", DbType:="VarChar(25) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_Tag", DbType:="VarChar(50) NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_CollegeDisplay", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _

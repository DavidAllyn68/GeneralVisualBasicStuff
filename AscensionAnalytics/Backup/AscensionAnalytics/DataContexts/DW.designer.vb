...
Partial Public Class DW_Policy
	...
	<Column(Storage:="_PolicyId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_PolicyAbbreviation", DbType:="VarChar(25) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_PolicyName", DbType:="VarChar(300) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_GroupId", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_UnderwriterId", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_PolicyYearId", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_EffectiveDate", DbType:="SmallDateTime NOT NULL")>  _
	...
	<Column(Storage:="_ExpirationDate", DbType:="SmallDateTime NOT NULL")>  _
	...
	<Column(Storage:="_OriginatingDataSourceId", DbType:="Int NOT NULL")>  _
	...
	<Association(Name:="DW_Datasource_DW_Policy", Storage:="_DW_Datasource", ThisKey:="OriginatingDataSourceId", OtherKey:="DataSourceId", IsForeignKey:=true)>  _
	...
	<Association(Name:="DW_Group_DW_Policy", Storage:="_DW_Group", ThisKey:="GroupId", OtherKey:="GroupId", IsForeignKey:=true)>  _
	...
	<Association(Name:="DW_Underwriter_DW_Policy", Storage:="_DW_Underwriter", ThisKey:="UnderwriterId", OtherKey:="UnderwriterId", IsForeignKey:=true)>  _
...
Partial Public Class DW_Datasource
	...
	<Association(Name:="DW_Datasource_DW_Policy", Storage:="_DW_Policies", ThisKey:="DataSourceId", OtherKey:="OriginatingDataSourceId")>  _
	...
	<Association(Name:="DW_Datasource_DW_Group", Storage:="_DW_Groups", ThisKey:="DataSourceId", OtherKey:="OriginatingDataSourceId")>  _
	...
	<Association(Name:="DW_Datasource_DW_Underwriter", Storage:="_DW_Underwriters", ThisKey:="DataSourceId", OtherKey:="OriginatingDataSourceId")>  _
	...
	<Association(Name:="DW_Datasource_DW_Client", Storage:="_DW_Clients", ThisKey:="DataSourceId", OtherKey:="OriginatingDataSourceId")>  _
	...
	<Association(Name:="DW_Datasource_DW_Population", Storage:="_DW_Populations", ThisKey:="DataSourceId", OtherKey:="OriginatingDataSourceId")>  _
	...
	<Association(Name:="DW_Datasource_DW_Product", Storage:="_DW_Products", ThisKey:="DataSourceId", OtherKey:="OriginatingDataSourceId")>  _
...
Partial Public Class DW_Group
	...
	<Column(Storage:="_GroupAbbreviation", DbType:="VarChar(15) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_GroupName", DbType:="VarChar(200) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_ClientId", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_PopulationId", DbType:="Int NOT NULL")>  _
	...
	<Association(Name:="DW_Group_DW_Policy", Storage:="_DW_Policies", ThisKey:="GroupId", OtherKey:="GroupId")>  _
	Public Property DW_Policies() As EntitySet(Of DW_Policy)
		Get
			Return Me._DW_Policies
		End Get
	...
	<Association(Name:="DW_Datasource_DW_Group", Storage:="_DW_Datasource", ThisKey:="OriginatingDataSourceId", OtherKey:="DataSourceId", IsForeignKey:=true)>  _
	Public Property DW_Datasource() As DW_Datasource
		Get
			Return Me._DW_Datasource.Entity
		End Get
	...
	<Association(Name:="DW_Client_DW_Group", Storage:="_DW_Client", ThisKey:="ClientId", OtherKey:="ClientId", IsForeignKey:=true)>  _
	...
	<Association(Name:="DW_Population_DW_Group", Storage:="_DW_Population", ThisKey:="PopulationId", OtherKey:="PopulationId", IsForeignKey:=true)>  _
	...
	<Association(Name:="DW_Product_DW_Group", Storage:="_DW_Product", ThisKey:="ProductId", OtherKey:="ProductId", IsForeignKey:=true)>  _
...
<Table(Name:="dbo.DW_Underwriters")>  _
Partial Public Class DW_Underwriter
	...
	<Column(Storage:="_UnderwriterId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	Public Property UnderwriterId() As Integer
		Get
			Return Me._UnderwriterId
		End Get
	...
	<Column(Storage:="_UnderwriterAbbreviation", DbType:="VarChar(15) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_UnderwriterName", DbType:="VarChar(200) NOT NULL", CanBeNull:=false)>  _
	...
	<Association(Name:="DW_Underwriter_DW_Policy", Storage:="_DW_Policies", ThisKey:="UnderwriterId", OtherKey:="UnderwriterId")>  _
	Public Property DW_Policies() As EntitySet(Of DW_Policy)
		Get
			Return Me._DW_Policies
		End Get
	...
	<Association(Name:="DW_Datasource_DW_Underwriter", Storage:="_DW_Datasource", ThisKey:="OriginatingDataSourceId", OtherKey:="DataSourceId", IsForeignKey:=true)>  _
	Public Property DW_Datasource() As DW_Datasource
		Get
			Return Me._DW_Datasource.Entity
		End Get
...
Partial Public Class DW_Client
	...
	<Column(Storage:="_ClientId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	Public Property ClientId() As Integer
		Get
			Return Me._ClientId
		End Get
	...
	<Column(Storage:="_ClientAbbreviation", DbType:="VarChar(15) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_ClientName", DbType:="VarChar(200) NOT NULL", CanBeNull:=false)>  _
	...
	<Association(Name:="DW_Client_DW_Group", Storage:="_DW_Groups", ThisKey:="ClientId", OtherKey:="ClientId")>  _
	Public Property DW_Groups() As EntitySet(Of DW_Group)
		Get
			Return Me._DW_Groups
		End Get
	...
	<Association(Name:="DW_Datasource_DW_Client", Storage:="_DW_Datasource", ThisKey:="OriginatingDataSourceId", OtherKey:="DataSourceId", IsForeignKey:=true)>  _
	Public Property DW_Datasource() As DW_Datasource
		Get
			Return Me._DW_Datasource.Entity
		End Get
...
<Table(Name:="dbo.DW_Populations")>  _
Partial Public Class DW_Population
	...
	<Column(Storage:="_PopulationId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	Public Property PopulationId() As Integer
		Get
			Return Me._PopulationId
		End Get
	...
	<Column(Storage:="_PopulationAbbreviation", DbType:="VarChar(15) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_PopulationName", DbType:="VarChar(200) NOT NULL", CanBeNull:=false)>  _
	...
	<Association(Name:="DW_Population_DW_Group", Storage:="_DW_Groups", ThisKey:="PopulationId", OtherKey:="PopulationId")>  _
	Public Property DW_Groups() As EntitySet(Of DW_Group)
		Get
			Return Me._DW_Groups
		End Get
	...
	<Association(Name:="DW_Datasource_DW_Population", Storage:="_DW_Datasource", ThisKey:="OriginatingDataSourceId", OtherKey:="DataSourceId", IsForeignKey:=true)>  _
	Public Property DW_Datasource() As DW_Datasource
		Get
			Return Me._DW_Datasource.Entity
		End Get
...
Partial Public Class DW_Product
	...
	<Column(Storage:="_ProductAbbreviation", DbType:="VarChar(15) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_ProductName", DbType:="VarChar(200) NOT NULL", CanBeNull:=false)>  _
	...
	<Association(Name:="DW_Product_DW_Group", Storage:="_DW_Groups", ThisKey:="ProductId", OtherKey:="ProductId")>  _
	Public Property DW_Groups() As EntitySet(Of DW_Group)
		Get
			Return Me._DW_Groups
		End Get
	...
	<Association(Name:="DW_Datasource_DW_Product", Storage:="_DW_Datasource", ThisKey:="OriginatingDataSourceId", OtherKey:="DataSourceId", IsForeignKey:=true)>  _
	Public Property DW_Datasource() As DW_Datasource
		Get
			Return Me._DW_Datasource.Entity
		End Get

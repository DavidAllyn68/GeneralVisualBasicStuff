...
<Table(Name:="dbo.TypeOfService")>  _
Partial Public Class DataWarehouseTypeOfService
	...
	<Column(Storage:="_TypeOfServiceId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_BETOSCode", DbType:="Char(3) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_TypeOfService", DbType:="VarChar(100) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_TypeOfServiceSubCategoryId", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_TypeOfServiceCategoryId", DbType:="Int NOT NULL")>  _
	...
	<Association(Name:="DataWarehouseTypeOfService_DataWarehouseService", Storage:="_DataWarehouseServices", ThisKey:="TypeOfServiceId", OtherKey:="TypeOfServiceId")>  _
	...
	<Association(Name:="DataWarehouseTypeOfServiceCategory_DataWarehouseTypeOfService", Storage:="_DataWarehouseTypeOfServiceCategory", ThisKey:="TypeOfServiceCategoryId", OtherKey:="TypeOfServiceCategoryId", IsForeignKey:=true)>  _
	...
	<Association(Name:="DataWarehouseTypeOfServiceSubCategory_DataWarehouseTypeOfService", Storage:="_DataWarehouseTypeOfServiceSubCategory", ThisKey:="TypeOfServiceSubCategoryId", OtherKey:="TypeOfServiceSubCategoryId", IsForeignKey:=true)>  _
...
<Table(Name:="dbo.TypeOfServiceCategories")>  _
Partial Public Class DataWarehouseTypeOfServiceCategory
	...
	<Column(Storage:="_TypeOfServiceCategoryId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	Public Property TypeOfServiceCategoryId() As Integer
		Get
			Return Me._TypeOfServiceCategoryId
		End Get
	...
	<Column(Storage:="_TypeOfServiceCategory", DbType:="VarChar(1000) NOT NULL", CanBeNull:=false)>  _
	...
	<Association(Name:="DataWarehouseTypeOfServiceCategory_DataWarehouseTypeOfService", Storage:="_DataWarehouseTypeOfServices", ThisKey:="TypeOfServiceCategoryId", OtherKey:="TypeOfServiceCategoryId")>  _
...
<Table(Name:="dbo.TypeOfServiceSubCategories")>  _
Partial Public Class DataWarehouseTypeOfServiceSubCategory
	...
	<Column(Storage:="_TypeOfServiceSubCategoryId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	Public Property TypeOfServiceSubCategoryId() As Integer
		Get
			Return Me._TypeOfServiceSubCategoryId
		End Get
	...
	<Column(Storage:="_TypeOfServiceSubCategory", DbType:="VarChar(1000) NOT NULL", CanBeNull:=false)>  _
	...
	<Association(Name:="DataWarehouseTypeOfServiceSubCategory_DataWarehouseTypeOfService", Storage:="_DataWarehouseTypeOfServices", ThisKey:="TypeOfServiceSubCategoryId", OtherKey:="TypeOfServiceSubCategoryId")>  _
	Public Property DataWarehouseTypeOfServices() As EntitySet(Of DataWarehouseTypeOfService)
		Get
			Return Me._DataWarehouseTypeOfServices
		End Get
...
Partial Public Class DataWarehouseDiagnoses
	...
	<Column(Storage:="_DiagnosisId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_DiagnosisCode", DbType:="VarChar(25) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_DiagnosisFullDescription", DbType:="VarChar(1000) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_DiagnosisAbbreviatedDescription", DbType:="VarChar(100) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_DiagnosisDatasourceId", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_DiagnosisCategoryId", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_DiagnosisCodeTypeId", DbType:="Int NOT NULL")>  _
	...
	<Association(Name:="DataWarehouseDatasources_DataWarehouseDiagnoses", Storage:="_DataWarehouseDatasources", ThisKey:="DiagnosisDatasourceId", OtherKey:="DataSourceId", IsForeignKey:=true)>  _
	...
	<Association(Name:="DataWarehouseDiagnosisCategories_DataWarehouseDiagnoses", Storage:="_DataWarehouseDiagnosisCategories", ThisKey:="DiagnosisCategoryId", OtherKey:="DiagnosisCategoryId", IsForeignKey:=true)>  _
	...
	<Association(Name:="DataWarehouseDiagnosisCodeType_DataWarehouseDiagnoses", Storage:="_DataWarehouseDiagnosisCodeType", ThisKey:="DiagnosisCodeTypeId", OtherKey:="DiagnosisCodeTypeId", IsForeignKey:=true)>  _
...
Partial Public Class DataWarehouseDatasources
	...
	<Column(Storage:="_DataSourceId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_DataSourceName", DbType:="VarChar(200) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_DataSourceNotes", DbType:="VarChar(1000)")>  _
	...
	<Column(Storage:="_DataSourceDelivery", DbType:="VarChar(30)")>  _
	...
	<Column(Storage:="_DataSourceClaimsTableName", DbType:="VarChar(200)")>  _
	...
	<Column(Storage:="_DataSourceWebsite", DbType:="VarChar(2000)")>  _
	...
	<Column(Storage:="_DataSourcePrimaryContact", DbType:="VarChar(300)")>  _
	...
	<Column(Storage:="_DataSourceLastImport", DbType:="SmallDateTime")>  _
	...
	<Association(Name:="DataWarehouseDatasources_DataWarehouseDiagnoses", Storage:="_DataWarehouseDiagnoses", ThisKey:="DataSourceId", OtherKey:="DiagnosisDatasourceId")>  _
...
<Table(Name:="dbo.DiagnosisCategories")>  _
Partial Public Class DataWarehouseDiagnosisCategories
	...
	<Column(Storage:="_DiagnosisCategoryId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	Public Property DiagnosisCategoryId() As Integer
		Get
			Return Me._DiagnosisCategoryId
		End Get
	...
	<Column(Storage:="_DiagnosisCategory", DbType:="VarChar(200) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_DiagnosisCodeRangeBegin", DbType:="VarChar(25) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_DiagnosisCodeRangeEnd", DbType:="VarChar(25) NOT NULL", CanBeNull:=false)>  _
	...
	<Association(Name:="DataWarehouseDiagnosisCategories_DataWarehouseDiagnoses", Storage:="_DataWarehouseDiagnoses", ThisKey:="DiagnosisCategoryId", OtherKey:="DiagnosisCategoryId")>  _
	Public Property DataWarehouseDiagnoses() As EntitySet(Of DataWarehouseDiagnoses)
		Get
			Return Me._DataWarehouseDiagnoses
		End Get
...
<Table(Name:="dbo.DiagnosisCodeTypes")>  _
Partial Public Class DataWarehouseDiagnosisCodeType
	...
	<Column(Storage:="_DiagnosisCodeTypeId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	Public Property DiagnosisCodeTypeId() As Integer
		Get
			Return Me._DiagnosisCodeTypeId
		End Get
	...
	<Column(Storage:="_DiagnosisCodeType", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _
	...
	<Association(Name:="DataWarehouseDiagnosisCodeType_DataWarehouseDiagnoses", Storage:="_DataWarehouseDiagnoses", ThisKey:="DiagnosisCodeTypeId", OtherKey:="DiagnosisCodeTypeId")>  _
	Public Property DataWarehouseDiagnoses() As EntitySet(Of DataWarehouseDiagnoses)
		Get
			Return Me._DataWarehouseDiagnoses
		End Get
...
Partial Public Class DataWarehouseService
	...
	<Column(Storage:="_ServiceCode", DbType:="VarChar(25) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_ServiceDescription", DbType:="VarChar(1000) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_TypeOfServiceId", DbType:="Int NOT NULL")>  _
	Public Property TypeOfServiceId() As Integer
		Get
			Return Me._TypeOfServiceId
		End Get
	...
	<Column(Storage:="_ServiceCodeTypeId", DbType:="Int")>  _
	...
	<Association(Name:="DataWarehouseTypeOfService_DataWarehouseService", Storage:="_DataWarehouseTypeOfService", ThisKey:="TypeOfServiceId", OtherKey:="TypeOfServiceId", IsForeignKey:=true)>  _
	...
	<Association(Name:="DataWarehouseServiceCodeType_DataWarehouseService", Storage:="_DataWarehouseServiceCodeType", ThisKey:="ServiceCodeTypeId", OtherKey:="ServiceCodeTypeId", IsForeignKey:=true)>  _
...
<Table(Name:="dbo.ServiceCodeTypes")>  _
Partial Public Class DataWarehouseServiceCodeType
	...
	<Column(Storage:="_ServiceCodeTypeId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_ServiceCodeType", DbType:="VarChar(25) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_ServiceCodeTypeDescription", DbType:="VarChar(200) NOT NULL", CanBeNull:=false)>  _
	...
	<Association(Name:="DataWarehouseServiceCodeType_DataWarehouseService", Storage:="_DataWarehouseServices", ThisKey:="ServiceCodeTypeId", OtherKey:="ServiceCodeTypeId")>  _
	Public Property DataWarehouseServices() As EntitySet(Of DataWarehouseService)
		Get
			Return Me._DataWarehouseServices
		End Get
...
Partial Public Class DataWarehouseBenefit
	...
	<Association(Name:="DataWarehouseBenefitCategory_DataWarehouseBenefit", Storage:="_DataWarehouseBenefitCategory", ThisKey:="BenefitCategoryId", OtherKey:="BenefitCategoryId", IsForeignKey:=true)>  _
...
<Table(Name:="dbo.BenefitCategories")>  _
Partial Public Class DataWarehouseBenefitCategory
	...
	<Column(Storage:="_BenefitCategoryId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	Public Property BenefitCategoryId() As Integer
		Get
			Return Me._BenefitCategoryId
		End Get
	...
	<Column(Storage:="_BenefitCategory", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _
	...
	<Association(Name:="DataWarehouseBenefitCategory_DataWarehouseBenefit", Storage:="_DataWarehouseBenefits", ThisKey:="BenefitCategoryId", OtherKey:="BenefitCategoryId")>  _

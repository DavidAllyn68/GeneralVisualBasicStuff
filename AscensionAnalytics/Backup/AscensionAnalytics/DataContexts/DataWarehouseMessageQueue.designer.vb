...
Partial Public Class DataWarehouseMessageQueueDataContext
  ...
  #End Region
	...
	<FunctionAttribute(Name:="dbo.MessageQueue_ProcessMessages")>  _
...
Partial Public Class MessageQueue
	...
	<Column(Storage:="_MessageQueueId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_MessageSenderAddress", DbType:="VarChar(100) NOT NULL", CanBeNull:=false, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_MessageCreatedDate", DbType:="SmallDateTime NOT NULL", IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_MessageSentDate", DbType:="SmallDateTime", IsDbGenerated:=true)>  _

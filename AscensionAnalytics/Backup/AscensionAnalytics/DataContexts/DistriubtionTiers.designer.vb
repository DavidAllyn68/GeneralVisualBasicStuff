...
<Table(Name:="dbo.Distributions")>  _
Partial Public Class Distribution
	...
	<Column(Storage:="_DistributionId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_DistributionName", DbType:="VarChar(100) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_DistributionDescription", DbType:="VarChar(1000) NOT NULL", CanBeNull:=false)>  _
	...
	<Association(Name:="Distribution_DistributionTier", Storage:="_DistributionTiers", ThisKey:="DistributionId", OtherKey:="DistributionId")>  _
...
<Table(Name:="dbo.DistributionTiers")>  _
Partial Public Class DistributionTier
	...
	<Column(Storage:="_DistributionTierId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_DistributionId", DbType:="Int NOT NULL")>  _
	Public Property DistributionId() As Integer
		Get
			Return Me._DistributionId
		End Get
	...
	<Column(Storage:="_TierFloor", DbType:="Float NOT NULL")>  _
	...
	<Column(Storage:="_TierCeiling", DbType:="Float NOT NULL")>  _
	...
	<Column(Storage:="_TierDisplay", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_sortOrder", DbType:="Float NOT NULL")>  _
	...
	<Association(Name:="Distribution_DistributionTier", Storage:="_Distribution", ThisKey:="DistributionId", OtherKey:="DistributionId", IsForeignKey:=true)>  _

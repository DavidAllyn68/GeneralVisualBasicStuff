...
Partial Public Class HthDataDataContext
  ...
  #End Region
	...
	<FunctionAttribute(Name:="dbo.hthFileImport_FinishAndCleanUp")>  _
	Public Function hthFileImport_FinishAndCleanUp() As Integer
		Dim result As IExecuteResult = Me.ExecuteMethodCall(Me, CType(MethodInfo.GetCurrentMethod,MethodInfo))
		Return CType(result.ReturnValue,Integer)
	End Function
	
	<FunctionAttribute(Name:="dbo.hthFileImport_LoadDenormForNightlyCompile")>  _
	...
	<FunctionAttribute(Name:="dbo.hthFileImport_ProcessDataTranslators")>  _
...
Partial Public Class HTH_GROUP
	...
	<Column(Storage:="_GROUP_CODE", DbType:="Int NOT NULL", IsPrimaryKey:=true)>  _
	...
	<Column(Storage:="_GROUP_DESCRIPTION", DbType:="VarChar(50)")>  _
	...
	<Column(Storage:="_SUB_GROUP_DESCRIPTION", DbType:="VarChar(50)")>  _
	...
	<Association(Name:="HTH_GROUP_HTH_GROUPS_MAP", Storage:="_HTH_GROUPS_MAP", ThisKey:="GROUP_CODE", OtherKey:="hth_group_cd", IsUnique:=true, IsForeignKey:=false)>  _
...
<Table(Name:="dbo.HTH_GROUPS_MAP")>  _
Partial Public Class HTH_GROUPS_MAP
	...
	<Column(Storage:="_hth_group_cd", DbType:="Int NOT NULL", IsPrimaryKey:=true)>  _
	...
	<Column(Storage:="_hth_group_ds", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_hth_sub_group_ds", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_ren_group_cd", DbType:="VarChar(10) NOT NULL", CanBeNull:=false)>  _
	...
	<Association(Name:="HTH_GROUP_HTH_GROUPS_MAP", Storage:="_HTH_GROUP", ThisKey:="hth_group_cd", OtherKey:="GROUP_CODE", IsForeignKey:=true)>  _

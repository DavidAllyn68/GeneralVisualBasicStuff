...
<Table(Name:="dbo.LineOfBusiness")>  _
Partial Public Class LineOfBusiness
	...
	<Column(Storage:="_LineOfBusinessId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_LineOfBusiness", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_LineOfBusinessCategoryId", DbType:="Int NOT NULL")>  _
	...
	<Association(Name:="LineOfBusiness_SchoolgroupLineOfBusiness", Storage:="_SchoolgroupLineOfBusinesses", ThisKey:="LineOfBusinessId", OtherKey:="LineOfBusinessId")>  _
	...
	<Association(Name:="LineOfBusinessCategory_LineOfBusiness", Storage:="_LineOfBusinessCategory", ThisKey:="LineOfBusinessCategoryId", OtherKey:="LineOfBusinessCategoryId", IsForeignKey:=true)>  _
...
<Table(Name:="dbo.LineOfBusinessCategories")>  _
Partial Public Class LineOfBusinessCategory
	...
	<Column(Storage:="_LineOfBusinessCategoryId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	Public Property LineOfBusinessCategoryId() As Integer
		Get
			Return Me._LineOfBusinessCategoryId
		End Get
	...
	<Column(Storage:="_LineOfBusinessCategory", DbType:="VarChar(200) NOT NULL", CanBeNull:=false)>  _
	...
	<Association(Name:="LineOfBusinessCategory_LineOfBusiness", Storage:="_LineOfBusinesses", ThisKey:="LineOfBusinessCategoryId", OtherKey:="LineOfBusinessCategoryId")>  _
...
<Table(Name:="dbo.SchoolgroupLineOfBusiness")>  _
Partial Public Class SchoolgroupLineOfBusiness
	...
	<Column(Storage:="_SchoolgroupLineOfBusinessId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_SchoolgroupCode", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_LineOfBusinessId", DbType:="Int NOT NULL")>  _
	Public Property LineOfBusinessId() As Integer
		Get
			Return Me._LineOfBusinessId
		End Get
	...
	<Association(Name:="LineOfBusiness_SchoolgroupLineOfBusiness", Storage:="_LineOfBusiness", ThisKey:="LineOfBusinessId", OtherKey:="LineOfBusinessId", IsForeignKey:=true)>  _

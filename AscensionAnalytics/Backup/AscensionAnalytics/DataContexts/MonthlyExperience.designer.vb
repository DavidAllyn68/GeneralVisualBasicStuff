...
<Table(Name:="dbo.monthly_experience")>  _
Partial Public Class monthly_experience
	...
	<Column(Storage:="_MonthlyExperienceId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_policyid", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_yearmo", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_year_char", DbType:="Char(4) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_month_char", DbType:="NVarChar(30) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_month_ending", DbType:="SmallDateTime NOT NULL")>  _
	...
	<Column(Storage:="_relative_year", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_relative_month", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_enrollment", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_enrollment_months", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_prem_due", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_prem_received", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_num_mbrs", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_num_claims", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_num_charges", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_tot_incurred_ServiceDate", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_tot_incurred", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_tot_ppodisc", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_tot_coinsurance", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_tot_copay", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_tot_deductible", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_tot_excluded", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_tot_otherins", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_tot_paid", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_cuml_enrollment", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_cuml_enrollment_months", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_cuml_prem_due", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_cuml_prem_received", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_cuml_charges", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_cuml_incurred_ServiceDate", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_cuml_incurred", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_cuml_ppodisc", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_cuml_coinsurance", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_cuml_copay", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_cuml_deductible", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_cuml_excluded", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_cuml_otherins", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_cuml_paid", DbType:="Money NOT NULL")>  _

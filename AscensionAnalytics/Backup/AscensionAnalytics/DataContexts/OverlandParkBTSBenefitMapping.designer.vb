...
<Table(Name:="dbo.OverlandParkBTS_BenefitMapping")>  _
Partial Public Class OverlandParkBTS_BenefitMapping
	...
	<Column(Storage:="_OPBTSBenefitMappingId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_OPBTSBenefitCode", DbType:="VarChar(25) NOT NULL", CanBeNull:=false)>  _
	...
	<Association(Name:="OverlandParkBTS_BenefitCode_OverlandParkBTS_BenefitMapping", Storage:="_OverlandParkBTS_BenefitCode", ThisKey:="OPBTSBenefitCode", OtherKey:="BenCode", IsForeignKey:=true)>  _
	...
	<Association(Name:="OPBTS_BenefitMapping_AscensionBenefit_OverlandParkBTS_BenefitMapping", Storage:="_OPBTS_BenefitMapping_AscensionBenefit", ThisKey:="AscensionBenefitId", OtherKey:="BenefitId", IsForeignKey:=true)>  _
...
<Table(Name:="dbo.OverlandParkBTS_BenefitCodes")>  _
Partial Public Class OverlandParkBTS_BenefitCode
	...
	<Column(Storage:="_BenefitID", DbType:="SmallInt NOT NULL", IsPrimaryKey:=true)>  _
	...
	<Column(Storage:="_BenCode", DbType:="VarChar(15) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_BenDescription", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_CovCode", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_BenCategoryID", DbType:="Int")>  _
	...
	<Association(Name:="OverlandParkBTS_BenefitCode_OverlandParkBTS_BenefitMapping", Storage:="_OverlandParkBTS_BenefitMappings", ThisKey:="BenCode", OtherKey:="OPBTSBenefitCode")>  _
...
Partial Public Class OPBTS_BenefitMapping_AscensionBenefit
	...
	<Association(Name:="OPBTS_BenefitMapping_AscensionBenefit_OverlandParkBTS_BenefitMapping", Storage:="_OverlandParkBTS_BenefitMappings", ThisKey:="BenefitId", OtherKey:="AscensionBenefitId")>  _
	Public Property OverlandParkBTS_BenefitMappings() As EntitySet(Of OverlandParkBTS_BenefitMapping)
		Get
			Return Me._OverlandParkBTS_BenefitMappings
		End Get

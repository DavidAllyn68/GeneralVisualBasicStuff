...
<Table(Name:="dbo.PIA_BenefitMapping")>  _
Partial Public Class PIA_BenefitMapping
	...
	<Column(Storage:="_PIABenefitMappingId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_PIABenefitCode", DbType:="VarChar(25) NOT NULL", CanBeNull:=false)>  _
	...
	<Association(Name:="PIA_Benefits_PIA_BenefitMapping", Storage:="_PIA_Benefits", ThisKey:="PIABenefitCode", OtherKey:="bencode", IsForeignKey:=true)>  _
	...
	<Association(Name:="PiaMapping_AscensionBenefits_PIA_BenefitMapping", Storage:="_PiaMapping_AscensionBenefits", ThisKey:="AscensionBenefitId", OtherKey:="BenefitId", IsForeignKey:=true)>  _
...
Partial Public Class PIA_Benefits
	...
	<Association(Name:="PIA_Benefits_PIA_BenefitMapping", Storage:="_PIA_BenefitMappings", ThisKey:="bencode", OtherKey:="PIABenefitCode")>  _
...
Partial Public Class PiaMapping_AscensionBenefits
	...
	<Association(Name:="PiaMapping_AscensionBenefits_PIA_BenefitMapping", Storage:="_PIA_BenefitMappings", ThisKey:="BenefitId", OtherKey:="AscensionBenefitId")>  _
	Public Property PIA_BenefitMappings() As EntitySet(Of PIA_BenefitMapping)
		Get
			Return Me._PIA_BenefitMappings
		End Get

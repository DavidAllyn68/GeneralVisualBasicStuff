...
<Table(Name:="dbo.Rating_StatisticTypes")>  _
Partial Public Class Rating_StatisticType
	...
	<Column(Storage:="_StatisticTypeId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_StatisticTypeName", DbType:="VarChar(100) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_StatisticTypeDescription", DbType:="VarChar(2000) NOT NULL", CanBeNull:=false)>  _
	...
	<Association(Name:="Rating_StatisticType_Rating_PolicyStatistic", Storage:="_Rating_PolicyStatistics", ThisKey:="StatisticTypeId", OtherKey:="StatisticTypeId")>  _
...
<Table(Name:="dbo.Rating_PolicyStatistics")>  _
Partial Public Class Rating_PolicyStatistic
	...
	<Column(Storage:="_PolicyStatisticId", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_StatisticTypeId", DbType:="Int NOT NULL")>  _
	Public Property StatisticTypeId() As Integer
		Get
			Return Me._StatisticTypeId
		End Get
	...
	<Column(Storage:="_StatisticValue", DbType:="Money NOT NULL")>  _
	...
	<Association(Name:="Rating_StatisticType_Rating_PolicyStatistic", Storage:="_Rating_StatisticType", ThisKey:="StatisticTypeId", OtherKey:="StatisticTypeId", IsForeignKey:=true)>  _
